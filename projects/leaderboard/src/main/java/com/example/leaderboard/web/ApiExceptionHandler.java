...
import com.example.leaderboard.service.LeaderboardWriteConflictException;
import com.example.leaderboard.service.PlayerNotFoundException;
...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(LeaderboardWriteConflictException.class)
    public ResponseEntity<ErrorResponse> handleConflict(LeaderboardWriteConflictException ex) {
